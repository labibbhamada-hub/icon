...
@section('title', 'Edit Registration Type')
        ...
        <div class="col-sm-6 d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    Update registration type and pricing information.
                </p>
...
@section('content')
    ...
    <form action="{{ route('admin.registration-types.update', $conferenceRegistrationType) }}" method="POST">
