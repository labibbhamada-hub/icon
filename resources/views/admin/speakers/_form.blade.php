            ...
            <div class="mb-2">
                @if (isset($speaker) && $speaker->photo)
                    <img src="{{ asset('storage/' . $speaker->photo) }}" alt="{{ $speaker->name }}" id="photo-preview"
                        class="img-thumbnail rounded-3 d-block" style="width: 180px; height: 180px; object-fit: cover;">
                @else
                    ...
                    <img src="" alt="Preview" id="photo-preview" class="img-thumbnail d-none rounded-3"
                        style="width: 180px; height: 180px; object-fit: cover;">
                @endif
            </div>

            <input type="file" name="photo" id="photo" accept="image/jpeg,image/png,image/webp"
                class="form-control @error('photo') is-invalid @enderror rounded-2">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-2">
                    ...
                    <input type="text" name="position" value="{{ old('position', $speaker->position ?? '') }}"
                        class="form-control @error('position') is-invalid @enderror rounded-2"
...
<div class="card-body border-top">
    <div class="row">
        ...
        <div class="col-12 mb-2">
            ...
            <textarea name="bio" rows="5" class="form-control @error('bio') is-invalid @enderror rounded-2"
        ...
        <div class="col-md-4 mb-2">
            ...
            <input type="email" name="email" value="{{ old('email', $speaker->email ?? '') }}"
                class="form-control @error('email') is-invalid @enderror rounded-2" placeholder="speaker@example.com">
        ...
        <div class="col-md-4 mb-2">
            ...
            <input type="url" name="linkedin" value="{{ old('linkedin', $speaker->linkedin ?? '') }}"
                class="form-control @error('linkedin') is-invalid @enderror rounded-2"
