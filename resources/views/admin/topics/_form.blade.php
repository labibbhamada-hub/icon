<div class="row">
    ...
    <div class="col-12 mb-3">
        ...
        <textarea rows="4" name="description" class="form-control">{{ old('description', $topic->description ?? '') }}</textarea>
    </div>
    <div class="col-md-4 mb-3">
        <label class="form-label">
            Bootstrap Icon
        </label>
        <input type="text" name="icon" value="{{ old('icon', $topic->icon ?? '') }}" class="form-control">
    </div>
    <div class="col-md-4 mb-3">
        <label class="form-label">
            Color
